...
public class SwaggerConfig {
    ...
    public OpenAPI foodServiceOpenAPI() {
        ...
        devServer.setDescription("Server URL for food Service in Development environment");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .contact(contact)
                .description("This API provides endpoints for food management including food items, stock levels, and availability tracking.")
